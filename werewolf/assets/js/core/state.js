        ...
        function attachRoomListeners(code) {
            ...
            roomMetaRef.update({
                ...
                voteOpen: gameState.started && gameState.phase === 'day' && !gameState.isPaused,
        ...
        function pushGameStateToFirebase() {
            ...
            try {
                ...
                db.ref(`rooms/${onlineRoomCode}/meta`).update({
                    ...
                    gameStarted: gameState.started,
                    isPaused: !!gameState.isPaused,
                    voteOpen: gameState.started && gameState.phase === 'day' && !gameState.isPaused && gameState._onlineVoteLockedDay !== gameState.day
                });
        ...
        function roleIconMarkup(role, className = 'role-lucide-icon') {
            return `<span class="${className}" aria-hidden="true"><i data-lucide="${getRoleIconName(role)}"></i></span>`;
        }
